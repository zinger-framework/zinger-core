...
public class TransactionQuery {
    ...
    public static final String getTransaction = "SELECT " + transactionId + ", " + bankTransactionId + ", " + currency + ", " + responseCode + ", " + responseMessage + ", " + gatewayName + ", " + bankName + ", " + paymentMode + ", " + checksumHash + " FROM " + tableName + " WHERE " + transactionId + " = :" + transactionId;
