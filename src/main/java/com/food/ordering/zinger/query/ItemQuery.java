...
public class ItemQuery {
    ...
    public static final String getItemById = "SELECT " + id + ", " + name + ", " + price + ", " + photoUrl + ", " + category + ", " + shopId + ", " + isVeg + ", " + isAvailable + " FROM " + tableName + " WHERE " + id + " = :" + id;
    public static final String getItemsByShopId = "SELECT " + id + ", " + name + ", " + price + ", " + photoUrl + ", " + category + ", " + shopId + ", " + isVeg + ", " + isAvailable + " FROM " + tableName + " WHERE " + shopId + " = :" + shopId + " AND " + notDeleted;
    public static final String getItemsByName = "SELECT " + id + ", " + name + ", " + price + ", " + photoUrl + ", " + category + ", " + shopId + ", " + isVeg + ", " + isAvailable + " FROM " + tableName + " WHERE " + name + " LIKE :" + name + " AND " + notDeleted + " AND " + shopId + " IN (" + ShopQuery.getShopIdByCollegeId + ")";
