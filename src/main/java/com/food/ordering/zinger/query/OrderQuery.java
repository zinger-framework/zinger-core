...
public class OrderQuery {
    ...
    public static final String getOrderByMobile = "SELECT " + id + ", " + mobile + ", " + transactionId + ", " + shopId + ", " + date + ", " + status + ", " + lastStatusUpdatedTime + ", " + price + ", " + deliveryPrice + ", " + deliveryLocation + ", " + cookingInfo + ", " + rating + ", " + secretKey + " FROM " +  tableName + " WHERE " + mobile + " = :" + mobile + orderByDesc;
    public static final String getOrderByShopId = "SELECT " + id + ", " + mobile + ", " + transactionId + ", " + shopId + ", " + date + ", " + status + ", " + lastStatusUpdatedTime + ", " + price + ", " + deliveryPrice + ", " + deliveryLocation + ", " + cookingInfo + ", " + rating + ", " + secretKey + " FROM " +  tableName + " WHERE " + shopId + " = :" + shopId + orderByDesc;
