...
public class OrderQuery {
    ...
    public static final String getOrderByShopIdPagination = "SELECT " + id + ", " + mobile + ", " + transactionId + ", " + shopId + ", " + date + ", " + status + ", " + lastStatusUpdatedTime + ", " + price + ", " + deliveryPrice + ", " + deliveryLocation + ", " + cookingInfo + ", " + rating + ", " + secretKey + " FROM " + tableName + " WHERE " + shopId + " = :" + shopId + " AND (" + status + " = '" + OrderStatus.CANCELLED_BY_SELLER.name() + "' || " + status + " = '" + OrderStatus.CANCELLED_BY_USER.name() + "' || " + status + " = '" + OrderStatus.COMPLETED.name() + "' || " + status + " = '" + OrderStatus.DELIVERED.name() + "')" + orderByDesc + Limit + ":" + pageCount + Offset + ":" + pageNum;
